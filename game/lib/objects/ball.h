...
void ballMovement(float *ballX, float *ballY, float ballRadius, float ballSpeedX, float ballSpeedY, float rightRectangleX, float rightRectangleY, float leftRectangleX, float leftRectangleY, float rectangleWidth, float rectangleHeight, int screenWidth, int screenHeight)
{
